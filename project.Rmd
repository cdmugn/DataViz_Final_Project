...
StyleCol <- colorFactor(palette = 'PuRd', beer_city$StyleColor)
```
...
- I may change the cut offs in my color scale so they change more, right now most beers are in the same category. So an evenly split range might not be in my best interest.
