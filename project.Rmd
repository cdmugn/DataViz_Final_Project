...
colScale <- scale_colour_manual("StyleColor", breaks = c('< 3.7', '3.7-3.8', '3.8-3.9', '3.9-4.1'),
                                values = c("#E0ECF4", "#9EBCDA", "#8C96C6", "#88419D"))
```
...
server <- function(input, output, session) {
  ...
  addTiles() %>% 
  addProviderTiles(providers$Wikimedia) %>% 
  addMarkers(lng = beer_city$lng, lat = beer_city$lat, clusterOptions = markerClusterOptions(singleMarkerMode = TRUE, color = "Purple"), label = lapply(paste("<strong> Beer name: </strong>", beer_city$Name.x,"<br> <strong> Brewery name: </strong>", beer_city$Name.y), htmltools::HTML))
  })
  ...
  coord_flip() + 
  labs(x = "Beer Style", y = "ABV content", title = "Average ABV content by Beer Style") + theme_dark() + theme(title=element_text(size=14,face="bold",color = "darkorange3"), axis.title = element_text(size = 12, face = "plain", color = "darkorange3"))
  })
  ...
  coord_flip() + 
  labs(x = "Beer Style", y = "IBU content", title = "Average IBU content by Beer Style") + theme_dark() + theme(title=element_text(size=14,face="bold", color = "darkorange3"), axis.title = element_text(size = 12, face = "plain", color = "darkorange3"))
  })
